...
class ClassifierTrainer:
    def __init__(self, log_files_directory: Path, training_config: TrainingConfig):
        ...
        self.model: AutoModelForSequenceClassification = AutoModelForSequenceClassification.from_pretrained(self.training_config.model_type, problem_type="multi_label_classification", num_labels=self.num_labels, # type: ignore
